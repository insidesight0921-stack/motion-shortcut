...
const lessons = {
  preparation: {
    ...
    steps: [
      [
        "자료 선택",
        "‘데모 덱으로 연습’에서 ‘발표 시작’을 누르면 5장의 데모가 별도 팝업에 열립니다.\n카메라 권한을 허용하면 모션이 자동으로 시작됩니다.",
      ],
      [
        "PDF 선택",
        "PDF 발표는 준비 중이며 현재는 데모 덱만 발표할 수 있습니다.",
      ],
      [
        "추가 자료",
      ...
      <section className="guide-details" aria-labelledby="guide-details-title">
        ...
        <details>
          ...
          <div className="guide-detail-body">
            <p>
              데모 덱 6장 또는 업로드한 PDF가 별도의 팝업 발표 창에 열립니다.
              <br />
              방향키와 이전·다음 버튼, 모션으로 페이지를 넘길 수 있습니다.
              <br />
        ...
        <details>
          ...
          <div className="guide-detail-body">
            <p>
              ...
              팝업 및 리디렉션을 허용한 뒤 다시 시도하세요.
              <br />
              추가 자료를 확인한 후에는 발표 창을 직접 선택해 돌아오세요.
            </p>
          </div>
        </details>
        <details>
